 ...
 *
 * Based on yans-wifi-helper.h by:
...
#ifndef PHYSIM_WIFI_HELPER_H
#define PHYSIM_WIFI_HELPER_H
...
/**
 * \brief manage and create Wifi channel objects for the PhySim model.
 *
 * The intent of this class is to make it easy to create a channel object
 * which implements the PhySim channel model.
 */
class PhySimWifiChannelHelper
{
public:
  /**
   ...
   */
  static PhySimWifiChannelHelper Default (void);
   ...
   */
  Ptr<PhySimWifiChannel> Create (void) const;
  ...
  */
  int64_t AssignStreams (Ptr<PhySimWifiChannel> c, int64_t stream);
 ...
 *
 * PcapHelperForDevice and AsciiTraceHelperForDevice both inherit from WifiPhyHelper
 */
class PhySimWifiPhyHelper : public PcapHelperForDevice,
